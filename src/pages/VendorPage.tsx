          ...
          <div className="absolute top-4 right-4 flex gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-full backdrop-blur-md ${
                isShopFav(shop.id) ? "bg-destructive/20 text-destructive" : "bg-card/80 text-foreground"
              }`}
            >
          ...
          {filteredFoods.map((food, idx) => {
            ...
            return (
              <button
                ...
                className="w-full text-left flex gap-3 p-3 rounded-2xl bg-card border border-border active:scale-[0.99] transition-transform card-lift"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-1">
                    ...
                    <button
                      ...
                      className={`flex-shrink-0 p-1 ${isFoodFav(food.id) ? "text-destructive" : "text-muted-foreground"}`}
                    >
                  ...
                  <div className="flex items-center justify-between mt-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="w-6 h-6 rounded-full bg-primary text-primary-foreground flex items-center justify-center btn-press"
                      >
